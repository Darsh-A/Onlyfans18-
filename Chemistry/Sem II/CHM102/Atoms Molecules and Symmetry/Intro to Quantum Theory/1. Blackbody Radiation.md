...
Planck's Distribution can also be expressed in terms of $\color{#ADD8E6}\text{wavelength}$ : 
$$
\begin{align}
\lambda \nu=c \\
d\nu=-c\frac{d\nu}{\nu^{2}}
...
Eq $(1.3)$ justifies an empirical relation known as the $\color{#FFCCCB}\text{Wien Displacement Law}$ which says that if $\lambda_{\text{max}}$ is the wavelength at which $\rho_{\lambda}(T)$ is a maximum then, 
