...
1. $\color{green}Effective\:Reducing\:Agents$
    ...
    \ce{ R - Cl + 2Li(s) ->[THF] RLi + LiCl  }$$
	 - When metal cation is stabilized without oxidizing reagent, it is possible to form salts of free or solvated electrons 
		 ...
		 - Sodium-Ammonia solutions useful for preparing [[0. References#Acetylides | acetylides]] and reduced organometallic complexes $$\require{mhchem}
...
2. $\color{green}Tendency\:to\:form\:peroxides\:and\:superoxides$
	...
	- Size effects are also responsible for alkali metal complexes with macrocyclic ligands: particularly crown ethers (A) and cryptands (C) ![[cryptands and crown ethers .png]]
