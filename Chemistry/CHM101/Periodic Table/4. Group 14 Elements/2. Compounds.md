...
## Silica$(SiO_{2})$ 
>$\color{grey}\text{Examples:}$ tridmyte, coesite, cristobalite and stishovite are all mineral forma of silica, stable at $\color{#90EE90}\text{high\:temperatures}$ and $\color{#90EE90}\text{pressures}$
