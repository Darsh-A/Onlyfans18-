...
#### Thiosulphuric Acid $H_{2}S_{2}O_{3}$ and polythionates 
...
$$
crystallizes to give $Na_{2}S_{2}O_{3}.5H_{2}O$
...
>	$$\require{mhchem}\ce{ H_{2}O_{2}->[ClSO_{3}H][-HCl] H_{2}SO_{5} ->[ClSO_{3}H][-HCl] H_{2}S_{2}O_{8} }\:\:\:\:\:(16.32)$$
>	$$\require{mhchem}\ce{ H_{2}S_{2}O_{8} + H_{2}O ->[273K] H_{2}SO_{5} + H_{2}SO_{4} }\:\:\:\:\:(16.33)$$ 
>	- Both are crystalline solids at $298K$ 
>	- Peroxydisulphides are strong oxidizing agents 
>	$$\require{mhchem}\ce{ [S_{2}O_{8}]^{2-} + 2e- <=> 2[SO_{4}]^{2-}}\: E^{\circ}=+2.01V\:\:\:\:\:(16.34)$$
>		- In acidic solutions, $[S_{2}O_{8}]^{2-}$ oxidizes $Mn^{2+}$ to $[MNO_{4}]^{-}$ and $Cr^{3+}$ to $[Cr_{2}O_{7}]^{2-}$  


### Sulphur-Nitrogen Compounds 
Best known compound: tetrasulphur tetranitride($S_{4}N_{4}$)
>- Diamagnetic orange solid, explodes when heated 
>- cradle-like ring in which 
>- $S-N$ bond distance in $S_{4}N_{4}$ indicates delocalised bodning with $\pi$ contributions
> ![](https://i.imgur.com/OV0GbF8.png)
>
>- Formation:
>$$\require{mhchem}\ce{ 6S_{2}Cl_{2} + 16NH_{3} ->[CCl_{4},320K] S_{4}N_{4} + 12NH_{4}Cl + S_{8} }\:\:\:\:\:(16.35)$$
>$$\require{mhchem}\ce{ 2{(Me_{3}Si)}_{2}N _{2}S + 2SCl_{2} + 2SO_{2}Cl_{2} \to S_{4}N_{4} + 8Me_{3}SiCl + 2SO_{2}}\:\:\:\:\:(16.36)$$
>- Slowly hydrolysed by water 
>$$\require{mhchem}\ce{ S_{4}N_{4} + 6[OH]- + 3H_{2}O -> [S_{2}O_{3}]^{2-} + 2[SO_{3}]^{2-} +4NH_{3} }\:\:\:\:\:(16.37)$$
>- Halogenation of $S_{4}N_{4}$:
>	- fluorination yields thiazyl fluoride $NSF$ ( slowly trimerizes to $S_{3}N_{3}F_{3}$ ) or thiazyl trifluoride $NSF_{3}$ which contain $\require{mhchem}\ce{ S#N }$ (both pungent gases at RT)
>	- Salt $[S_{3}N_{2}Cl]^{+}[Cl]^{-}$ is made by heating a mixture of $S_{2}Cl_{2}$, $S$ and $HCl$ 
>	- Oxidationof $S_{4}N_{4}$ with $AsF_{5}$ and $SbF_{5}$ gives $[S_{4}N_{4}][EF_{6}]_{2}\:\text{(E= Sb or As)}$ containing $[S_{4}N_{4}]^{2+}$ ![](https://i.imgur.com/vITFmt0.png)
>	
>	- $S_{4}N_{4}$ cage can be degraded to $S_{2}N_{2}$ which is isolectronic with $[S_{4}]^{2+}$
>	$S_{2}N_{2}$
>		- $S_{2}N_{2}$ is planar with delocalised bonding$(S-N\:=\: 165\text{pm})$ ![](https://i.imgur.com/GAapQvj.png)
>		- at room temp, converts to lustrous golden-yellow fibrous polymer $(SN)_{\text{x}}$ which decomposes explosively at $520\:\text{K}$ and can also be sublimed in vacuo at $410\text{ K}$  
>		
>	- Has electrical conductance about one-quarter of that of mercury in the direction of the polymer chains and at $0.3\text{ K}$, becomes a super conductor 
