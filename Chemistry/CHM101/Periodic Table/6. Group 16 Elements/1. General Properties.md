...
- These include $\require{mhchem}\ce{ S_{6}, S_{7}, S_{8}, S_{9}, S_{11}, S_{12}, S_{18}, S_{20} }$**(all puckered rings)** and fibrous sulphur$\require{mhchem}\ce{ ( catena-S_{\infty})}$
>In most of these, $S-S$ bond distances are $206\pm 1 \text{pm}$