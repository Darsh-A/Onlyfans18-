...
- Higher boranes are formed by pyrolytic removal of $H_{2},H^{-}$, and/or $H^{+}$ units from$BH_{3}$ or $BH_{4}^{-}$ 
	...
	Consider the structure of *closo-dodecarborante* $[B_{12}H_{12}]^{2-}$(Diameter similar to benzene ring)![[Pasted image 20230114145020.png]]
...
>- For $Al$, monomer and dimer are often in equilibrium for smaller alkyl groups, 
> 
