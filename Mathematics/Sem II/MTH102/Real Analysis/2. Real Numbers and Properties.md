...
Let $A$ be a nonempty set that is bounded above. We call a number $α$ a _least upper bound_ or _supremum_ of $A$, if

1.  x≤α for all x∈A�≤� for all �∈� (that is, α� is an upper bound of A�);
2.  If M� is an upper bound of A�, then α≤M�≤� (this means α� is smallest among all upper bounds).